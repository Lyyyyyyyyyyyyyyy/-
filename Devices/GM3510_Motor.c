...
{
	GM3510s.realAngle = (uint16_t)(CanRxBuff[0]<<8 | CanRxBuff[1]);
	GM3510s.realTorque = (int16_t)(CanRxBuff[2]<<8 | CanRxBuff[3]);
	/*过零处理开始*/
	/*总角度*/
	...
	GM3510s.totalAngle = GM3510s.realAngle + (8192*GM3510s.turnCount);
