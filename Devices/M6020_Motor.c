...
void M6020_getInfo(uint8_t* CanRxBuff, uint32_t MotorID)
{
	...
	M6020s.realAngle = (uint16_t)(CanRxBuff[0]<<8 | CanRxBuff[1]);
	M6020s.realSpeed = (int16_t)(CanRxBuff[2]<<8  | CanRxBuff[3]);
	M6020s.realTorque = (int16_t)(CanRxBuff[4]<<8 | CanRxBuff[5]);
	...
	M6020s.totalAngle = M6020s.realAngle + (8192*M6020s.turnCount);
